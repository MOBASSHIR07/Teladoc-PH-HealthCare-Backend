...
// const createMyDoctorSchedule = async (user : JwtPayload, payload : ICreateDoctorSchedulePayload) => {
...
const getMyDoctorSchedules = async (user : JwtPayload, query : IQueryParams) => {
...
const updateMyDoctorSchedule = async (user : JwtPayload, payload: IUpdateDoctorSchedulePayload) => {
        const doctorData = await prisma.doctor.findUniqueOrThrow({
            where:{
                email : user.email
            }
...
const deleteMyDoctorSchedule = async (id: string, user: JwtPayload) => {
    const doctorData = await prisma.doctor.findUniqueOrThrow({
        where: {
            email: user.email
        }
