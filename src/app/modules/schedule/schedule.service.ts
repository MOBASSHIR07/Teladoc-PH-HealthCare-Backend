...
// new condition if doctor did not booked this slot then only can be updated
// const updateSchedule = async (id: string, payload: IUpdateSchedulePayload) => {
//     const { startDate, endDate, startTime, endTime } = payload;

//     const isScheduleUsed = await prisma.doctorSchedules.findFirst({
//         where: {
//             scheduleId: id
...
//     if (isScheduleUsed) {
//         throw new AppError(400, "This schedule is already assigned to a doctor and cannot be updated!");
//     }
