...
const changeAppointmentStatus = catchAsync(async (req: Request, res: Response) => {
    ...
    const updatedAppointment = await AppointmentService.changeAppointmentStatus(appointmentId as string, payload.status, user);
    sendResponse(res, {
        success: true,
        httpStatusCode: status.OK,
...
const getMySingleAppointment = catchAsync(async (req: Request, res: Response) => {
    ...
    const appointment = await AppointmentService.getMySingleAppointment( user , appointmentId as string);
    sendResponse(res, {
        success: true,
        httpStatusCode: status.OK,
